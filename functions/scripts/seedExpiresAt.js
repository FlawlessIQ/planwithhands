#!/usr/bin/env node
/**
 * Firestore TTL Seeder Script (JavaScript version)
 ...
 */
function createTTLTimestamp(days) {
 ...
 */
async function seedDocument(docRef, ttlDays, dryRun) {
  try {
 ...
 */
async function seedCollectionGroup(collectionName, ttlDays, limit, dryRun) {
  try {
 ...
 */
async function seedTopLevelCollection(collectionPath, ttlDays, limit, dryRun) {
  try {
 ...
 */
async function seedCollection(config, limit, dryRun) {
