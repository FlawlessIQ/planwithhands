...
class FirestoreConnectionDebug {
  static Future<void> checkFirestoreConnection() async {
    try {
      ...
      // Set offline persistence settings for web
      if (kIsWeb) {
        try {
          await FirebaseFirestore.instance.enablePersistence();
          debugPrint('[FIRESTORE_DEBUG] Offline persistence enabled for web');
        } catch (e) {
          debugPrint('[FIRESTORE_DEBUG] Could not enable persistence (might already be enabled): $e');
        }
      }
