          ...
          Expanded(
            child: DropdownButtonFormField<String?>(
              ...
              items: [
                ...
                ...snapshot.session.availableLocations.map((location) =>
      ...
      child: Column(
        ...
        children: [
          ...
          if (checklists.isNotEmpty)
            ...checklists.map((checklist) => _buildChecklistTile(context, checklist)),
...
class DashboardPerformanceMonitor extends HookWidget {
  ...
  const DashboardPerformanceMonitor({Key? key, required this.child}) : super(key: key);
