...
class HandsColors {
  ...
  static const Color cardPrimary = Color(
    0xFF1A1A1A,
  ); // Header card color (charcoal)
  static const Color cardTertiary = Color(
    0xFF383838,
  ); // Tertiary sub-container color (dark charcoal grey)
  ...
  static const Color error = Color(
    0xFFD32F2F,
  ); // Error color (old red moved here)
  // Missed task / muted error variants
  static const Color missedRed = Color(
    0xFF8B1E1E,
  ); // darker, less saturated red for accents
  static const Color missedRedBorder = Color(0xFF7A1A1A);
  static const Color missedRedContainer = Color(
    0xFF3F1414,
  ); // dark container background for missed tasks
...
class HandsDecorations {
  ...
  static BoxDecoration get tertiaryBoxDecoration => BoxDecoration(
    color: HandsColors.cardTertiary,
    borderRadius: BorderRadius.circular(12),
  );

  static BoxDecoration primaryBoxDecorationWithRadius(double radius) =>
      BoxDecoration(
        color: HandsColors.primaryContainer,
...
final ThemeData handsTheme = ThemeData(
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: ButtonStyle(
      ...
      side: WidgetStateProperty.all<BorderSide>(
        const BorderSide(color: HandsColors.handsOrange, width: 2),
      ),
      shape: WidgetStateProperty.all<RoundedRectangleBorder>(
        RoundedRectangleBorder(borderRadius: BorderRadius.circular(14.0)),
      ),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(14.0),
      borderSide: const BorderSide(color: HandsColors.handsOrange, width: 1.5),
    ),
