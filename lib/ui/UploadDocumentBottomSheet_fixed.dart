...
class UploadDocumentBottomSheet extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    print('DEBUG UPLOAD: userState.userData: ${userState.userData}');
    print('DEBUG UPLOAD: organizationId from userState: ${userState.userData?.organizationId}');
    print('DEBUG UPLOAD: organizationId from useState: ${organizationId.value}');
      ...
      Future<void> loadOrganizationId() async {
        try {
          ...
          if (userState.userData?.organizationId != null) {
            ...
            print('DEBUG UPLOAD: Using organizationId from userState: ${organizationId.value}');
            return;
          }
          ...
          if (currentUser != null) {
            print('DEBUG UPLOAD: Current user UID: ${currentUser.uid}');
            ...
            if (userDoc.exists) {
              ...
              print('DEBUG UPLOAD: Loaded organizationId from Firestore: $orgId');
            } else {
              print('DEBUG UPLOAD: User document does not exist');
            }
          } else {
            print('DEBUG UPLOAD: No current user');
          }
        } catch (e) {
          print('DEBUG UPLOAD: Error loading organizationId: $e');
        } finally {
          isLoadingOrgId.value = false;
        }
      }
