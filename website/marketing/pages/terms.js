...
export default function Terms() {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Terms of Service - Plan With Hands",
    "description": "Terms of service for Plan With Hands restaurant management software. Legal terms and conditions for using our platform.",
    "url": "https://planwithhands.com/terms/"
  };

  return (
    <>
      <SEO
        title="Terms of Service - Plan With Hands | Restaurant Management Software"
        description="Terms of service for Plan With Hands restaurant management software. Legal terms and conditions for using our platform and services."
        canonical="https://planwithhands.com/terms/"
        structuredData={structuredData}
        keywords="terms of service, legal terms, restaurant software terms, plan with hands terms"
      />
  return (
